...
#### side network 
class BertMeanDotProductPredictionHead(nn.Module):
    def __init__(self, args, token_embeddings, side_embedding1, side_embedding2, side_embedding3, input_size=None):
        super().__init__()
        self.token_embeddings = token_embeddings
        self.side_embedding1 = side_embedding1
        self.side_embedding2 = side_embedding2
        self.side_embedding3 = side_embedding3
...
class BertL2PredictionHead2(nn.Module):
    def __init__(self, args):
        super().__init__()
        hidden = args.hidden_units
        self.vocab_size = args.num_items + 1
